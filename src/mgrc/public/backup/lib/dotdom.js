            ...
            : pKeys.map(                                 // - Element nodes have properties
                (
                  ...
                  : (_new_dom._lk = pKeys) &&                           // Save the last used keys in _lk
                    ...
                    (_new_dom.getAttribute(key) !== nnode.P[key] &&     // All properties are applied directly to DOM, as
                    (_new_dom.setAttribute(key, nnode.P[key]))))        // long as they are different than ther value in the
